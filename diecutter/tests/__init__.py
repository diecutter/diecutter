...
def settings(template_dir):
    ...
    return {'diecutter.template_dir': template_dir, 'diecutter.template_engine': 'diecutter.engines:Jinja2Engine', 'diecutter.filename_template_engine': 'diecutter.engines:FilenameEngine'}
